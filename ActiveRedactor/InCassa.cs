...
{
    public partial class InCassa : Form
    {
        public InCassa()
        {
            InitializeComponent();
        ...
        private void InCassa_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            BoxSum.Text = row.Cells[1].Value.ToString();
            BoxCurrency.Text = row.Cells[2].Value.ToString();
        }
        ...
        private void Addbtn_Click(object sender, EventArgs e)
        {
            try
            {
                table.Rows.Add(BoxId.Text, BoxSum.Text, BoxCurrency.Text);
            }
            catch
            {
                MessageBox.Show("oops");
